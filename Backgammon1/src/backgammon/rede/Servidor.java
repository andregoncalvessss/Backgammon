                ...
                try {
                    ...
                    while ((comando = finalCliente.in.readLine()) != null) {
                        ...
                        if (comando.equals("LANCAR")) {
                            if (jogo != null && jogoJaComecou.get()) {
                                if (finalCliente.nome.equals(jogo.getJogadorAtual().getNome())) {
                                    jogo.lancarDados();
                                    sendGameStateToAll();
                                } else {
                                ...
                                finalCliente.out.println("COMANDO_INVALIDO:Aguarde o sorteio inicial.");
                                finalCliente.out.flush();
                            }
